...
public class LEDSubsystem extends SubsystemBase{
    ...
    //max brightness
    private final LEDPattern rainbowTemplate = LEDPattern.rainbow(255, RobotBase.isReal() ? 64 : 255);
    ...
    private final LEDPattern ScrollingRainbow = rainbowTemplate.scrollAtAbsoluteSpeed(MetersPerSecond.of(1.0), kLedSpacing);
    private final LEDPattern ScrollingGrad = gradTemplate.scrollAtAbsoluteSpeed(MetersPerSecond.of(4), kLedSpacing);
